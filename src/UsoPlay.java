...
public class UsoPlay {
	// Input method
	public static int input(UsoHand unohand) {
	...
	public static void main(String[] args) {
		...
		Field field;
		UsoHand playerHands;
		UsoHand computerHands1;
		UsoHand computerHands2;
		int pass;

		playerHands = new UsoHand();
		computerHands1 = new UsoHand();
		computerHands2 = new UsoHand();
